...
def show_task_intro():
    ...
    print('\n=== Navigation Task ===')
    print('Goal: navigate to the target object shown in the reference image.')
...
if __name__ == '__main__':
    ...
    obs = env.reset()
    t0 = time.time()
    print('Use I/J/K/L for movement, F=open_door, H=enter/exit vehicle, Ctrl=crouch, E=pickup, Space=jump, Up/Down=view.')
    while True:
